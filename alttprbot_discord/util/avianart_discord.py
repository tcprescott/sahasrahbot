...
from alttprbot.alttprgen.randomizer.avianart import AVIANART
...
class AVIANARTDiscord(AVIANART):
    def __init__(self, *args, **kwargs):
        super(AVIANARTDiscord, self).__init__(*args, **kwargs)
    ...
    async def embed(self, emojis=False, name=False, notes=False):
        ...
        embed.add_field(name='Preset', value=self.preset, inline=False)
