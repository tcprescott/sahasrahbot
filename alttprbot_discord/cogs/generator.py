...
## Command structure
# base command will be /alttpr /sm /smz3 /ctjets
# subcommands will exist for mystery, preset, spoiler
# command arguments will exist for race, quickswap (alttpr), etc

alttpr = discordbot.command_group(
    name='alttpr',
    description='Generate ALTTP Randomizer Games'
)
...
class Generator(commands.Cog):
    ...
    @alttpr.command(name="test")
    async def alttpr_cmd(self, ctx, ctx2):
