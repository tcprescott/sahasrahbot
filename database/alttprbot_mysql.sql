...
CREATE TABLE `audit_messages` (
  ...
  `attachment` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL,
  `deleted` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_audit_messages_message_id` (`message_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17769 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=11153 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9412 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-17  4:17:24
