...
async def load_extensions():
    ...
    await discordbot.load_extension("alttprbot.presentation.discord.cogs.nickname")
    await discordbot.load_extension("alttprbot.presentation.discord.cogs.racetime_tools")
    ...
    if getattr(config, 'DISCORD_ROLE_ASSIGNMENT_ENABLED', True):
        await discordbot.load_extension("alttprbot.presentation.discord.cogs.role")
        await discordbot.load_extension("alttprbot.presentation.discord.cogs.voicerole")
    ...
    if config.DEBUG:
        await discordbot.load_extension("alttprbot.presentation.discord.cogs.test")
