...
from alttprbot.services import AuditService
from alttprbot.services.seedgen import generator, smvaria
from alttprbot.services.seedgen.randomizer import smdash, z2r
from alttprbot.services.seedgen.spoilers import (generate_spoiler_game,
...
class AlttprUtils(commands.GroupCog, name="alttprutils", description="Utilities for the ALTTP Randomizer"):
    ...
    async def verifygame(
        ...
        """
        result = await AuditService().get_generated_game_by_hash_id(hash_id)
        if not result:
