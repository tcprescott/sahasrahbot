...
class ALTTPRLeague(ALTTPRTournamentRace):
    ...
    async def roll(self):
        ...
        # else:
        self.seed, self.preset_dict = await generator.ALTTPRPreset(self.league_data['preset']).generate(allow_quickswap=True, tournament=True, hints=False, spoilers="off")
