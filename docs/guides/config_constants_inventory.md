...
- Scan result summary: 40 files with config constant reads, 40 unique constants
...
| `GSHEET_API_OAUTH` | 1 | `alttprbot/util/gsheet.py` |
...
| `RACETIME_CSRF_TOKEN` | 1 | `alttprbot/tournaments.py` |
...
| `RACETIME_SESSION_TOKEN` | 1 | `alttprbot/tournaments.py` |
...
| `TOURNAMENT_RESULTS_SHEET` | 1 | `alttprbot/tournament/core.py` |
