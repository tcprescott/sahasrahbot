...
alttprbot/services/seedgen/randomizer/mysterydoors.py.
...
from alttprbot.services.seedgen.randomizer import mysterydoors
from alttprbot.services.seedgen.randomizer.mysterydoors import generate_doors_settings
