...
Targets ``SMDashProvider`` from alttprbot/alttprgen/provider_adapters.py. The
...
from alttprbot.alttprgen import provider_adapters
from alttprbot.alttprgen.provider_adapters import SMDashProvider
