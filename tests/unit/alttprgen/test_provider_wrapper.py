...
alttprbot/alttprgen/provider_wrapper.py. External HTTP is never made; the
...
from alttprbot.alttprgen import provider_wrapper
from alttprbot.alttprgen.provider_wrapper import (
    _is_retryable_error,
