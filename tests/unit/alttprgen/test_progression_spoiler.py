...
alttprbot/alttprgen/ext/progression_spoiler.py. ``mw_filter`` (multiworld
...
from alttprbot.alttprgen.ext import progression_spoiler
from alttprbot.alttprgen.ext.progression_spoiler import REGIONLIST, create_progression_spoiler
